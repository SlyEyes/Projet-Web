...
@section('content')
    <main class="main">
        <section class="section section-md">
                ...
                <p> L'entreprise individuelle Julien Wolff, soucieuse des droits des individus, notamment au regard des traitements automatisés et dans une volonté de transparence avec ses clients, a mis en place une politique reprenant l'ensemble de ces traitements, des finalités poursuivies par ces derniers ainsi que des moyens d'actions à la disposition des individus afin qu'ils puissent au mieux exercer leurs droits.
                </p>
                <p>
                    Pour toute information complémentaire sur la protection des données personnelles, nous vous invitons à consulter le site :<a href="https://www.cnil.fi/">https://www.cnil.fi/</a> 
                </p>
                <p>
                ...
                <h3>1.2 Editeur du site:</h3>
                <p>
                Julien Wolff
                </p>
                <p>
                Située : 6 rue du bois chènes le loup. 54547 vandoeuvre-lès-nancy 
                </p>
                <p>
                    Immatriculée au RCS de Vandoeuvre-lès-nancy 123456789
                </p>
                <p>
                N° de téléphone : 7894561230
                </p>
                <p>
                Adresse mail: contact@linked-out fr
                </p>
                <h3>1.3 Hébergeur</h3>
                <p>
                Linked-out est hébergé par pulseheberg, dont le siège social est situé 9 boulevard de strasbourg 83000 Toulon, France.
                </p>
                <h2>Article 2-Accès au site</h2>
                <p>
                L'accès au site et son utilisation sont réservés à un usage strictement personnel. Vous vous engagez à ne pas utiliser ce site et le informations ou données qui y figurent à des fins commerciales, politiques, publicitaires et pour toute forme de sollicitation commerciale et notamment l'envoi de courriers électroniques non sollicités.
                </p>
                ...
                <p>
                L'éditeur n'est pas responsable des dommages causés à vous-même, à des tiers et/ou à votre équipement du fait de votre connexion ou de votre utilisation du site et vous renoncer à toute action contre lui de ce fait.
                </p>
                <p>
                ...
                <p>
                Vos données sont collectées par l'entreprise individuelle Julien Wolff.
                </p>
                <p>
                ...
                <p>
                6 rue de bois chênes le loup 54547 Vandœuvre-lès-Nancy
                </p>
                <p>
                Ou par email, à l'adresse :
                </p>
                <p>
                contact@linked-out.fr
                </p>
                <p>
                Toute demande doit être accompagnée de la photocopie d'un titre d'identité en cours de validité signé et faire mention de l'adresse à laquelle l'éditeur pourra contacter le demandeur. La réponse sera adressée dans le mois suivant la réception de la demande. Ce délai d'un mois peut être prolongé de deux mois si la complexité de la demande et on le nombre de demandes l’exigent.
                </p>
                <p>
                De plus, et depuis la loi n°2016-1321 du 7 octobre 2016, les personnes qui le souhaitent, ont la possibilité d'organiser le sort de leurs données après leur décès. Pour plus d'information sur le sujet, vous pouvez consulter le site Internet de la <a href="https://www.cnil.fr/"> CNIL</a> .
                </p>
                <p>
                ...
                <p>
                Vous êtes susceptible de recevoir des offres commerciales de l'éditeur. Si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : <a href="mailto:contact@linked-out.fr">contact@linked-out.fr</a>.
                </p>
                <p>
                Vos données sont susceptibles d'être utilisées par les partenaires de l'éditeur à des fins de prospection commerciale, si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : <a href="mailto:contact@linked-out.fr">contact@linked-out.fr</a>.
                </p>
                <p>
                ...
                <p>
                -cookies requis permettant la gestion des utilisateurs
                </p>
                <p>
                ...
                <p>Pour toute question, information sur les produits présentés sur le site, ou concernant le site lui-même, vous pouvez laisser un message à l'adresse suivante : <a href="mailto:contact@linked-out.fr">contact@linked-out.fr</a>.
                </p>
